...
import logistica.infraestructura.Mesa;
import organizacion.rrhh.empleados.Mesero;
import organizacion.rrhh.consumidores.Cliente;
import organizacion.rrhh.consumidores.Categoria;
import logistica.productos.consumibles.Plato;
import logistica.productos.bebibles.Bebida;
import ventas.OrdenVenta;
import ventas.LineaOrdenVenta;
